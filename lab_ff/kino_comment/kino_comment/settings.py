"""
Django settings for kino_comment project.
...
SECRET_KEY = 'django-insecure-o*#fdjd^3e^%wi$-k10ax66a#l#ece!1a1kqj@w3((!%fw*un+'
...
ROOT_URLCONF = 'kino_comment.urls'
...
WSGI_APPLICATION = 'kino_comment.wsgi.application'
